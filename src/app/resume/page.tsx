...
const Resume:React.FC = () => {
    ...
    <h1>Portfolio</h1>
    <p>A section in which you can see my ~professional work experience~</p>
    <div>
        <button>design</button>
        <button>project management</button>
        <button>pure development</button>
    </div>
    <hr/>
    ...
    <div id="timeline">
        <div className="section">
            ...
            <p>Led the front-end migration of 8 legacy API calls to GraphQL to support Azure group migration on an Electron-React app used by 200,000 employees globally to check device health on computers. - Helped consolidate 2 administrative React-Typescript
                ...
                required to maintain 1481 software packages. - Supported GE split by performing the following actions: produced key documentation for legacy services, cloning and testing applications, 109 repositories and their supporting infrastructure,
                including 200+ resources for 3 environments, 44 APIs receiving upwards of 2k+ requests monthly, ensuring a smooth transition and reduction of unnecessary resources from 800+ in prod environments to 324. - Discovered an authentication security
                threat solution that tied 3 environments of an application with a separate application, solved by correctly aligning the client ids of the application with the correct appregistration allowing us to divorce ourselves from the dependency
                and better troubleshoot in the future.</p>
        </div>
        <hr/>
        <div className="section">
            <h2>Recurse</h2>
